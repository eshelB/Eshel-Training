...
import (
	...
	"github.com/eshelB/my-checkers/testutil/sample"
	mycheckerssimulation "github.com/eshelB/my-checkers/x/mycheckers/simulation"
...
var (
	_ = sample.AccAddress
	_ = mycheckerssimulation.FindAccount
...
const (
	...
	opWeightMsgPlayMove = "op_weight_msg_create_chain"
	// TODO: Determine the simulation weight value
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	mycheckersGenesis := types.GenesisState{
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&mycheckersGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreateGame,
		mycheckerssimulation.SimulateMsgCreateGame(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgPlayMove,
		mycheckerssimulation.SimulateMsgPlayMove(am.accountKeeper, am.bankKeeper, am.keeper),
	))
