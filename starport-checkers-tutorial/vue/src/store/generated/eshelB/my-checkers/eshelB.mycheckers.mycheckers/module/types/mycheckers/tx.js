...
export class MsgClientImpl {
    ...
    CreateGame(request) {
        ...
        const promise = this.rpc.request("eshelB.mycheckers.mycheckers.Msg", "CreateGame", data);
        return promise.then((data) => MsgCreateGameResponse.decode(new Reader(data)));
    }
    PlayMove(request) {
        const data = MsgPlayMove.encode(request).finish();
        const promise = this.rpc.request("eshelB.mycheckers.mycheckers.Msg", "PlayMove", data);
