...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryAdd = (query, params = {}) => this.request({
         ...
         */
        this.queryDiv = (query, params = {}) => this.request({
         ...
         */
        this.queryMul = (query, params = {}) => this.request({
         ...
         */
        this.querySub = (query, params = {}) => this.request({
