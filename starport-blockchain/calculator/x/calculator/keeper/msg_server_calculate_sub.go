...
func (k msgServer) CalculateSub(goCtx context.Context, msg *types.MsgCalculateSub) (*types.MsgCalculateSubResponse, error) {
	...
	if err != nil {
		...
		return &types.MsgCalculateSubResponse{Result: "0"}, nil
	}
	...
	return &types.MsgCalculateSubResponse{Result: result}, nil
}
