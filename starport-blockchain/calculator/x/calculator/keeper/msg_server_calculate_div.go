...
func (k msgServer) CalculateDiv(goCtx context.Context, msg *types.MsgCalculateDiv) (*types.MsgCalculateDivResponse, error) {
	...
	if err != nil {
		...
		return &types.MsgCalculateDivResponse{Result: "0"}, nil
	}
	...
	return &types.MsgCalculateDivResponse{Result: result}, nil
}
